...
QT_MOC_LITERAL(3, 23, 20), // "dimsWallpaperChanged"
QT_MOC_LITERAL(4, 44, 11), // "typeChanged"
QT_MOC_LITERAL(5, 56, 12), // "colorChanged"
QT_MOC_LITERAL(6, 69, 13), // "onPathChanged"
QT_MOC_LITERAL(7, 83, 4), // "path"
QT_MOC_LITERAL(8, 88, 4), // "type"
QT_MOC_LITERAL(9, 93, 13), // "dimsWallpaper"
QT_MOC_LITERAL(10, 107, 5) // "color"

    },
    "Wallpaper\0pathChanged\0\0dimsWallpaperChanged\0"
    "typeChanged\0colorChanged\0onPathChanged\0"
    "path\0type\0dimsWallpaper\0color"
};
...
void Wallpaper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->onPathChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Wallpaper::pathChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        {
            using _t = void (Wallpaper::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Wallpaper::typeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Wallpaper::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Wallpaper::colorChanged)) {
                *result = 3;
                return;
            }
        }
        ...
        case 2: *reinterpret_cast< bool*>(_v) = _t->dimsWallpaper(); break;
...
// SIGNAL 2
void Wallpaper::typeChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void Wallpaper::colorChanged()
{
